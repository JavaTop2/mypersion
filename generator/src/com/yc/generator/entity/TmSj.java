...
public class TmSj {
    ...
    public String getCommodityPj() {
        return commodityPj;
    }

    public void setCommodityPj(String commodityPj) {
        this.commodityPj = commodityPj == null ? null : commodityPj.trim();
    }
